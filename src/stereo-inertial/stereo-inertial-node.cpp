    ...
    SLAM_(SLAM)
{
    ...
    subImgLeft_ = this->create_subscription<ImageMsg>("camera_front", 100, std::bind(&StereoInertialNode::GrabImageLeft, this, _1));
    subImgRight_ = this->create_subscription<ImageMsg>("camera_side", 100, std::bind(&StereoInertialNode::GrabImageRight, this, _1));
